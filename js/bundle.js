  ...
  function createCard(data) {
  	data.forEach(({ img, altimg, title, descr, price }) => {
  		...
  		element.innerHTML = `
  			...
  			<div class="menu__item-price">
  				<div class="menu__item-cost">Цена:</div>
  				<div class="menu__item-total"><span>${price}</span></span> грн/день</div>
  			</div>
  		`;
...
/* harmony default export */ __webpack_exports__["default"] = (forms); //* FETCH запрос 
